...
export const MODULE_DEFS = {
  wall:  { size: [2, 2.4, 0.25], yOff: 1.2,  color: 0xe8e4da },
  floor: { size: [2, 0.2, 2],    yOff: 0.1,  color: 0xb08454 },
  roof:  { size: [2.2, 0.3, 2.2], yOff: 2.7, color: 0x33393f },
};
export const GRID = 2;
...
export function makeModuleMesh(type, ghost = false) {
  ...
  const mat = new THREE.MeshStandardMaterial({
    color: d.color, roughness: 0.8, transparent: ghost, opacity: ghost ? 0.5 : 1,
  });
